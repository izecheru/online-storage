...
export default function UploadMenu() {
  ...
  return (
    <div className="file-upload">
          ...
          {fileDropZone.isUploading === true ? (
            <div className="uploading-isLoading">
              <p>
                ...
                {((100 * count) / fileDropZone.files.length).toFixed(0)}%{" "}
              </p>
              <Image
      ...
      <button className="start-upload" onClick={uploadFiles}>
        Start to upload all available files!
      </button>
      <button className="erase-files" onClick={fileDropZone.resetFileArray}>
        Erase files from upload queue!
      </button>
